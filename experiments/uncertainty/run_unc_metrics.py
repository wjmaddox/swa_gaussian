...
def get_path(filename, append=""):
    print(os.path.join(args.path, filename + append + ".npz"))
    return os.path.join(args.path, filename + append + ".npz")
...
# Temperature scaling
if swa_val["predictions"] is not None:
...
if sgd_val["predictions"] is not None:
...
for metric, metric_name in metrics:
    ...
    for method, name in methods:
        metric(method, name, print_name=args.print_names)
    print()
