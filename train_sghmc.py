...
parser.add_argument('--sghmc', action='store_true', help='whether to use sghmc instead of sgd (default: sgd')
parser.add_argument('--L', type=int, default=1, help='number of leapfrog steps to use in sghmc (default: 1)')
...
if args.swa:
    ...
    print('SGD-like training without averaging')
...
if args.sghmc:
    print('Performing inference with SGHMC, please use swa or some other method to store posterior samples')
    ...
    print('Performing optimization with SGHMC')
